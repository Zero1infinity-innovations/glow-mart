        ...
        @if (count($cartItems) > 0)
            ...
            <div class="col-lg-5 mt-4 mt-lg-0">
                <div class="card p-4">
                    ...
                    <!-- Items List -->
                    <h5 class="fw-bold mt-3">Item ({{ count($cartItems) }})</h5>

                    @foreach($cartItems as $item)
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-2" id="cart-item-{{ $item->id }}">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset($item->product->product_image) }}" class="product-img me-2" style="height: 50px;">
                                <div>
                                    <p class="mb-0">{{ $item->product->product_name }} ({{ $item->quantity }}x)</p>
