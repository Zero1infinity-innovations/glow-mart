...
@section('bodyContent')
    <?php
    $banners = [
        (object) ['image' => asset('theme/images/banner1.png')], 
        (object) ['image' => asset('theme/images/banner3.png')], 
        (object) ['image' => asset('theme/images/banner4.png')]];
    $browserCategories = [
        (object) ['image' => asset('theme/images/Categories/Categories1.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories2.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories3.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories4.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories5.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories6.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories7.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories8.png')], 
        (object) ['image' => asset('theme/images/Categories/Categories9.png')]
    ];
    ?>
    <!-- Bootstrap Carousel -->
        ...
        <div class="category-container pt-5">
            @foreach ($categories as $key => $categorie)
                <div class="category-card">
                    <a href="#">
                        <img src="{{ $categorie->category_image }}" alt="image-{{ $key }}">
                    </a>
                </div>
            @endforeach
        </div>
