    ...
    <div class="card-body p-2">
        ...
        <form class="row g-3" id="categoryForm">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="seo_title" id="seo_title" class="form-control"  value="{{$category->seo_title}}"/>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="gmc_category" id="gmc_category" class="form-control" value="{{$category->gmc_category}}"/>
...
<script>
    categoryForm.onsubmit = async (e) =>{
        e.preventDefault();
        makePostRequest("{{route('admin.category.update')}}",categoryForm,'categoryForm')
    }
</script>
@endpush