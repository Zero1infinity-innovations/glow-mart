        ...
        <form class="row g-3" id="categoryForm">
            ...
            <div class="col-md-4">
                ...
                <select name="banner_type" id="banner_type" class="form-control">
                    ...
                    <option value="mobile" @selected($banner->banner_type=='Mobile')>Mobile</option>
                    <option value="desktop" @selected($banner->banner_type=='Desktop')>Desktop</option>
                </select>
...
<script>
    categoryForm.onsubmit = async (e) =>{
        e.preventDefault();
        makePostRequest("{{route('admin.banner.update')}}",categoryForm,'categoryForm')
    }
</script>
@endpush
